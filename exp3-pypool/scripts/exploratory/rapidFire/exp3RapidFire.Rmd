---
title: "Experiment 3 Pypool Rapid Fire"
author: "Dave Braun"
date: "7/21/2019"
output: 
  html_document:
...
setwd('/home/dave/Dropbox (Lehigh University)/Research/By Project/Dissertation/experiments/analysis/exp2/scripts/exploratory/rapidFire/')
```


*This document was last updated at `r Sys.time()`.*

This document is dedicated to exploring the Experiment 3 with pypool data choice data from the rapid fire phase against that from the demand selection task phase. The general purpose is to assess whether or not this choice data is usable.  
