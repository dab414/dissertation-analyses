---
title: "Experiment 3 Pypool Preprocessing"
author: "Dave Braun"
date: "7/24/2019"
output: 
  html_document:
...
setwd('/home/dave/Dropbox (Lehigh University)/Research/By Project/Dissertation/experiments/analysis/exp2/scripts/preprocessing/')
```
...
```{r}
N_analyzed <- length(unique(dst[dst$corrected_effort_units=='false',]$subject))
```


**The initial sample size is `r n`.**

**The initial sample size for only those in the uncorrected condition (which is what is being reported as E2B in the ms) is `r N_analyzed`.**
