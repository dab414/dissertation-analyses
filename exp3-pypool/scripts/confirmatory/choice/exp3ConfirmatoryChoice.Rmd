---
title: "Experiment 3 Pypool Confirmatory Choice Analyses"
author: "Dave Braun"
date: "Fall 2021"
output: 
  html_document:
...
This document is dedicated to the confirmatory choice analyses that were proposed for Experiment 3 with pypool data. 
...
**Since we know rounding didn't have any impact, I'm restricting analyses to only un-rounded data**
