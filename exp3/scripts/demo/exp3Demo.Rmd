---
title: "`r paste('Experiment', ifelse(stringr::str_detect(getwd(), 'exp3'), 3, 2), 'Demographic Summary')`"
author: "Dave Braun"
date: "7/21/2019"
output: 
  html_document:
...
setwd('/home/dave/OneDrive/Research/By Project/Dissertation/experiments/analysis/exp2/scripts/demo/')
```



This document is dedicated to summarizing the demographic data from Experiment `r ifelse(stringr::str_detect(getwd(), 'exp3'), 3, 2)`.  
