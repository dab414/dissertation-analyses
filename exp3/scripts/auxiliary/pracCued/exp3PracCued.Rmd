---
title: "Experiment 3 Practice Cued Task Switching Analyses"
author: "Dave Braun"
date: "7/21/2019"
output: 
  html_document:
...
This document is dedicated to analyzing the data from the practice cued task switching portion of Experiment 3. Subjects performed 9, 17-trial cycles of cued tasks switching, for a total of 153 trials. I'm going to trim these data the same way that the perforamnce data for DST data was trimmed, and then perform two paired t-tests were transition predicts (1) RT and (2) error rate.
