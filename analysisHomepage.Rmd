...
* [Exploratory Choice RT Analysis](https://davebraun.org/dissertation/experiments/analysis/exp1/scripts/exploratory/choicePerformance/){target=_blank}  
  * Breaking down choice RTs by the 2 X 2 design.  
* [Exploratory Performance Analysis](https://davebraun.org/dissertation/experiments/analysis/exp1/scripts/exploratory/performance/){target=_blank}    
...
* [Exploratory Performance Analysis](https://davebraun.org/dissertation/experiments/analysis/exp2/scripts/exploratory/performance/){target=_blank}  
...
* [Exploratory Choice RT Analysis](https://davebraun.org/dissertation/experiments/analysis/exp2/scripts/exploratory/choicePerformance/){target=_blank}  
  * Breaking down choice RTs by the 2 X 2 design.  
...
* [Exploratory Rapid Fire Choice Analysis](https://davebraun.org/dissertation/experiments/analysis/exp3/scripts/exploratory/rapidFire/){target=_blank}  
  * Exploring the choice data from the rapid fire phase, and making subject-wise exclusions based on choice data from both DST and rapid fire.  
* [Exploratory Performance Analysis](https://davebraun.org/dissertation/experiments/analysis/exp3/scripts/exploratory/performance/){target=_blank}  
  * Analyzing to see whether performance depends on the difficulty variable. RTs for reference are faster for easier than reference conditions relative to harder conditions. 
* [Exploratory Random Effects Analysis](https://davebraun.org/dissertation/experiments/analysis/exp3/scripts/exploratory/randomEffects/){target=_blank}
  * Fitting generalized linear mixed models to the choice data in an effort to control for between-subject variance in the predicted effects.     
* [Exploratory Choice RT Analysis](https://davebraun.org/dissertation/experiments/analysis/exp3/scripts/exploratory/choicePerformance/){target=_blank}  
  * Breaking down choice RTs by the 2 X 2 design.
