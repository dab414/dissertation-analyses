...
Watch out, X-axes are on different scales. At first it would appear that there's the most variability in the difference, but after looking at the scales, difference actually has the least amount of variability. Also remember everything is on the log odds scale, which can make interpretation difficult.
...
I notice that the critical effect (i.e., main effect of difficulty) still has zero within its 95% confidence band. Although we haven't looked at p-values yet, this might suggest that the difficulty variable did not have a significant impact on preference for the safe deck. This main effect of difference seems more reliable, however, and it suggests that people become more risk seeking as the difference in effort intensity becomes more extreme. 
...
I think that's about as accurate as it gets. The effect of difficulty is not significant `r emo::ji('loudly crying face')`.
